...
const RELIC_DB = [
    ...
    name: '混沌精華', 
    icon: '🌀', 
    desc: '命運時刻：沿用舊版命運輪盤邏輯，解鎖 [輪盤槽]。進入後轉動輪盤，使選中的已擁有屬性數量翻倍。', 
    rarity: 'legendary', 
    effect: 'unlock_slot', 
    slotType: 'wheel',
    maxStacks: 1
    ...
    name: '純淨精華',
    icon: '🤍',
    desc: '命運時刻：下一次命運抉擇改為只選 1 枚彈珠，並可注入 1 個屬性合法的符文。',
    rarity: 'epic',
    effect: 'pure_essence',
    maxStacks: 3
    },
    ...
    { id: 'surge_bounce',  name: '弹性涌潮', icon: '🔵', desc: '下兩回合必定刷新出「弹性彈珠」，且弹性彈珠的同化率 x2（持續兩回合）。', rarity: 'rare',  effect: 'assimilation_surge', marbleType: 'bounce',  maxStacks: 1 },
    { id: 'surge_pierce',  name: '穿透涌潮', icon: '↗',       desc: '下兩回合必定刷新出「穿透彈珠」，且穿透彈珠的同化率 x2（持續兩回合）。', rarity: 'cursed',  effect: 'assimilation_surge', marbleType: 'pierce',  maxStacks: 1 },
    { id: 'surge_scatter', name: '散射涌潮', icon: '🔱',       desc: '下兩回合必定刷新出「散射彈珠」，且散射彈珠的同化率 x2（持續兩回合）。', rarity: 'legendary',  effect: 'assimilation_surge', marbleType: 'scatter', maxStacks: 1 },
    { id: 'surge_damage',  name: '增幅涌潮', icon: '⚔️',       desc: '下兩回合必定刷新出「增幅彈珠」，且增幅彈珠的同化率 x2（持續兩回合）。', rarity: 'rare',  effect: 'assimilation_surge', marbleType: 'damage',  maxStacks: 1, recommended: true, tags: ['伤害爆发', '属性强化'], recommendTip: '快速将钉子同化为增幅属性，爆发期间伤害大幅飙升！' },
    { id: 'surge_cryo',    name: '冰霜涌潮', icon: '❄️',       desc: '下兩回合必定刷新出「冰霜彈珠」，且冰霜彈珠的同化率 x2（持續兩回合）。', rarity: 'rare',  effect: 'assimilation_surge', marbleType: 'cryo',    maxStacks: 1 },
    { id: 'surge_pyro',    name: '火焰涌潮', icon: '🔥',       desc: '下兩回合必定刷新出「火焰彈珠」，且火焰彈珠的同化率 x2（持續兩回合）。', rarity: 'rare',  effect: 'assimilation_surge', marbleType: 'pyro',    maxStacks: 1 },
