...
class DropBall {
        ...
        handlePegInteraction(peg, game) {
            ...
            // 3. 原有的普通同化逻辑 (Fallback)
                ...
                // [新增] 同化涌潮遗物加成：仅对该弹珠类型生效，改为显式双倍字段
                if (game.doubleAssimilationBoostRounds && game.doubleAssimilationBoostRounds[ballType] > 0) {
                    assimilationChance *= (CONFIG.gameplay.assimilationDoubleMultiplier || 2);
                }
