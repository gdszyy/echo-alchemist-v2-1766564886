...
export const ENEMY_V2_METADATA = [
    {
        ...
        stage: '中段（第 4 回合起）',
        role: '横向阻挡 / 高生命阵地',
        counter: '使用穿透或激光绕过装甲面，避免短弹道反弹堆叠。',
