...
export const EVENT_TYPES = {
    ...
    ROUND_START_REWARD_QUEUED: 'round:start_reward_queued',
    ROUND_START_RESOLUTION_STARTED: 'round:start_resolution_started',
    ROUND_START_RESOLUTION_FINISHED: 'round:start_resolution_finished',
