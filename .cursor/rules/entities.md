...
| **Layer 3.8c** | Boss 本体 Sprite | **2026-06-22 更新**：`_drawBossDecoration()` 优先绘制 `assets/sprites/bosses/boss_<bossId>.png`；旧 `256 × 256` 方形帧保持中央贴图，新 `384 × 256` 横向帧按 3×2 Boss 占格居中绘制。Sprite 只承担本体外观，破绽、血条、温度、狂暴、行动预警仍由上层 Canvas/Overlay 负责。 |
