...
| PI-006 | Round-Start 延迟奖励结算流程 | v1.8 | game_phase, game_system, core, ui/shop, ui/run_shop | 2026-06-23 | [PI-006_round_start_reward_resolver.md](PI-006_round_start_reward_resolver.md) |
...
| `AGENTS.md` / `.cursor/rules/global.md` / `TODO.md` | PI-012（任务结束前 Git 状态闸门、未跟踪文件归属、临时产物与 stash 清理规范、多 Codex 并行 worktree 隔离） |
