...
> 自动生成于 2026-04-20 | 总行数: 1948 | 函数数: 43 | 语言: javascript
...
| triggerScreenShake | method | L1215 | L1222 | 8 | `triggerScreenShake(amount)` |
| drawWindTunnelFlow | method | L1223 | L1251 | 29 | `drawWindTunnelFlow(rect, isHorizontal)` |
...
| sys_hasRunState | method | L1708 | L1716 | 9 | `sys_hasRunState()` |
