...
| `src/effects/particles.js` | 1371 | 58 | 0 | 0 | [src_effects_particles_js_index.md](src_effects_particles_js_index.md) |
| `src/ui_system.js` | 1352 | 40 | 0 | 0 | [src_ui_system_js_index.md](src_ui_system_js_index.md) |
| `src/ui/hud.js` | 1019 | 14 | **1** | 0 | [src_ui_hud_js_index.md](src_ui_hud_js_index.md) |
| `src/entities/projectile.js` | 1001 | 13 | **2** | 0 | [src_entities_projectile_js_index.md](src_entities_projectile_js_index.md) |
...
| 文件 | 行数 | 函数数 |
|------|------|--------|
| `src/combat/damage_calc.js` | 460 | 7 |
| `src/ui/game_over.js` | 454 | 12 |
| `src/ui/shop.js` | 454 | 6 |
| `src/rune_system.js` | 444 | 9 |
| `src/combat/collision.js` | 432 | 3 |
| `src/core.js` | 416 | 5 |
| `src/calc_utils.js` | 332 | 8 |
| `src/loot_system.js` | 302 | 6 |
| `src/event_bus.js` | 258 | 13 |
| `src/utils/math_utils.js` | 170 | 17 |
| `src/combat/collision_shapes.js` | 146 | 2 |
