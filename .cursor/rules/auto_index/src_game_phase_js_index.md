...
> 自动生成于 2026-04-26 | 总行数: 2521 | 函数数: 16 | 语言: javascript
...
| phase_gathering_initPachinko | method | `phase_gathering_initPachinko(shouldInherit = false)` | ⚠️ 巨型函数，见 @section 导航 |
