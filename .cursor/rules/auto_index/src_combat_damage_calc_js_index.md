# src\combat\damage_calc.js 函数索引

> 自动生成于 2026-06-27 | 总行数: 558 | 函数数: 9 | 语言: javascript
...
| combat_lightningVenom_createProcKey | method | `combat_lightningVenom_createProcKey(shotId = null)` |  |
| combat_lightningVenom_trigger | method | `combat_lightningVenom_trigger(enemy, shotId = null, chainDepth = 0, procKey = null)` |  |
| combat_lightning_triggerChain | method | `combat_lightning_triggerChain(sourceEnemy, dmg, history, level = 1, shotId = null, chainChanceBonus = 0, isExtraChain = false, chainGuaranteeState = null, lightningVenomProcKey = null)` |  |
