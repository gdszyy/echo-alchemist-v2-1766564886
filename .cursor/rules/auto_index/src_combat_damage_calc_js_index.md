...
> 自动生成于 2026-06-18 | 总行数: 478 | 函数数: 7 | 语言: javascript
...
| combat_lightning_triggerChain | method | `combat_lightning_triggerChain(sourceEnemy, dmg, history, level = 1, shotId = null, chainChanceBonus = 0, isExtraChain = false)` |  |
